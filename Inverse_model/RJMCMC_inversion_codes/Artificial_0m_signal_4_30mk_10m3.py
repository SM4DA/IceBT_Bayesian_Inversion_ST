...
measured_temps=np.load('/home/kshaju/IceBT_Bayesian_inversion/Data/Gaussian_pulse_signals/Artificial_measurements/Artificial_measurements_4_2_temps_40eq_signal_4.npy')
...
def main():
    ...
    while  len(samples)< num_samples:
        ...
        if len(samples)%50000 == 0:
            ...
            with open('/home/kshaju/IceBT_Bayesian_inversion/RJMCMC_reconstructions/output/sampler_output/A1_0m_signal_4_30mk_10m3.pkl', 'wb') as f:
                dill.dump(samples,f) 
    ...
    with open('/home/kshaju/IceBT_Bayesian_inversion/RJMCMC_reconstructions/output/sampler_output/A1_0m_signal_4_30mk_10m3.pkl', 'wb') as f:
        dill.dump(samples,f) 
    np.save('/home/kshaju/IceBT_Bayesian_inversion/RJMCMC_reconstructions/output/sampler_output/run_time_A1_0m_signal_4_30mk_10m3',run_time)
main()
