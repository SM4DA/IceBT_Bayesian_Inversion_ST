...
measured_depths=np.linspace(0,200,20)
measured_temps=np.load('/albedo/work/projects/p_inverT/Ice_BT/data/Gaussian_pulse_signals/Artificial_measurements/Artificial_measurements_4_2_temps_20eq_signal_4.npy')
...
with open('/albedo/work/projects/p_inverT/Ice_BT/output/sampler_output/KS_final_runs/Artificial_signal_4_20eq_10mK_conti1.pkl', 'wb') as f:
    dill.dump(sampler,f)
