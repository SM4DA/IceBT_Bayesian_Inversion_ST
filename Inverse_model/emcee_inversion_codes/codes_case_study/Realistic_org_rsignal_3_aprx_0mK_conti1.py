...
with Pool(122) as pool:
    ...
    pos,prob,state = sampler.run_mcmc(last_positions, 60000, rstate0=rstate, progress=True)
    #pos,prob,state = sampler.run_mcmc(p0, 60000)


with open('/albedo/work/projects/p_inverT/Ice_BT/output/sampler_output/KS_final_runs/Realistic_org_rsignal_3_aprx_0mK_conti1.pkl', 'wb') as f:
    dill.dump(sampler,f)
