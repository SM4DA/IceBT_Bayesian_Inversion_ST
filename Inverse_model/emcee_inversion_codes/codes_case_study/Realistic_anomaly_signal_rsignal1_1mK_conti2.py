...
rsignal=np.load('/albedo/work/projects/p_inverT/Ice_BT/data/case_study/time_series_used/Signal_rsignal_1.npy')
rsmooth_signal= np.load('/albedo/work/projects/p_inverT/Ice_BT/data/case_study/time_series_used/Signal_rsignal_1_smooth.npy')
...
with open('/albedo/work/projects/p_inverT/Ice_BT/output/sampler_output/KS_final_runs/Realistic_anomaly_signal_rsignal1_1mK_conti1.pkl', 'rb') as f:
...
with open('/albedo/work/projects/p_inverT/Ice_BT/output/sampler_output/KS_final_runs/Realistic_anomaly_signal_rsignal1_1mK_conti2.pkl', 'wb') as f:
    dill.dump(sampler,f)
