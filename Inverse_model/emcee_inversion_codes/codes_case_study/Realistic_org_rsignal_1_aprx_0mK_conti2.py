...
measured_temps=np.load('/albedo/work/projects/p_inverT/Ice_BT/data/case_study/Realistic_artificial_measurements/Realistic_artificial_measured_temps_40eq_rsignal_1_40kic.npy')
measurmt_error=np.load('/albedo/work/projects/p_inverT/Ice_BT/data/case_study/Realistic_artificial_measurements/approx_uncertainty_rmsq_int40eq.npy')
...
def lnlike(p, tlist, measured_depths, measured_temps, sigma_m): 
    ...
    if not np.isfinite(lp_ic):
        ...
        _ic=select_ICs_p01mK(ics,qnew[0])
...
with open('/albedo/work/projects/p_inverT/Ice_BT/output/sampler_output/KS_final_runs/Realistic_org_rsignal_1_aprx_0mK_conti1.pkl', 'rb') as f:
...
with Pool(122) as pool:
    ...
    pos,prob,state = sampler.run_mcmc(last_positions, 20000, rstate0=rstate, progress=True)
    #pos,prob,state = sampler.run_mcmc(p0, 60000)


with open('/albedo/work/projects/p_inverT/Ice_BT/output/sampler_output/KS_final_runs/Realistic_org_rsignal_1_aprx_0mK_conti2.pkl', 'wb') as f:
    dill.dump(sampler,f)
