...
measured_temps=np.load('/albedo/work/projects/p_inverT/Ice_BT/data/case_study/Realistic_artificial_measurements/Realistic_artificial_measured_temps_40eq_rsigna_2_smooth_ensemble.npy')[10]
...
with open('/albedo/work/projects/p_inverT/Ice_BT/output/sampler_output/KS_final_runs/Realistic_smooth_signal_PA1_11_1mK_conti1.pkl', 'rb') as f:
...
with open('/albedo/work/projects/p_inverT/Ice_BT/output/sampler_output/KS_final_runs/Realistic_smooth_signal_PA1_11_1mK_conti2.pkl', 'wb') as f:
    dill.dump(sampler,f)
