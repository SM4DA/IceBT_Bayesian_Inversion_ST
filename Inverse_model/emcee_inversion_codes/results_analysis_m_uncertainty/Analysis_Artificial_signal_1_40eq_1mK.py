...
sampler1=None 
with open('/albedo/work/projects/p_inverT/Ice_BT/output/sampler_output/KS_final_runs/Artificial_signal_1_40eq_1mK.pkl', 'rb') as f:
    sampler1=dill.load(f)

sampler2=None
with open('/albedo/work/projects/p_inverT/Ice_BT/output/sampler_output/KS_final_runs/Artificial_signal_1_40eq_1mK_conti1.pkl', 'rb') as f2:
...
#----------------------------------------------------------------------------saving_results------------------------------------------------------------------------------
np.save('/albedo/work/projects/p_inverT/Ice_BT/output/output_analysed/KS_final_runs/Artificial_signal_1_40eq_1mK_POM_mean',POM_mean)
np.save('/albedo/work/projects/p_inverT/Ice_BT/output/output_analysed/KS_final_runs/Artificial_signal_1_40eq_1mK_POM_map',POM_map)
np.save('/albedo/work/projects/p_inverT/Ice_BT/output/output_analysed/KS_final_runs/Artificial_signal_1_40eq_1mK_ic',select_ICs(ics,qmean[0]))
np.save('/albedo/work/projects/p_inverT/Ice_BT/output/output_analysed/KS_final_runs/Artificial_signal_1_40eq_1mK_qmean',qmean)
np.save('/albedo/work/projects/p_inverT/Ice_BT/output/output_analysed/KS_final_runs/Artificial_signal_1_40eq_1mK_qmap',qmap)
np.save('/albedo/work/projects/p_inverT/Ice_BT/output/output_analysed/KS_final_runs/Artificial_signal_1_40eq_1mK_lower_bound',lower_bound)
np.save('/albedo/work/projects/p_inverT/Ice_BT/output/output_analysed/KS_final_runs/Artificial_signal_1_40eq_1mK_upper_bound',upper_bound)
