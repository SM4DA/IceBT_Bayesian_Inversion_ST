...
measurmt_error=0.03 # standard deviation of measurement uncertainty in K 
...
with open('/albedo/work/projects/p_inverT/Ice_BT/output/sampler_output/KS_final_runs/Artificial_signal_1_40eq_30mK_conti1.pkl', 'wb') as f:
    dill.dump(sampler,f)
