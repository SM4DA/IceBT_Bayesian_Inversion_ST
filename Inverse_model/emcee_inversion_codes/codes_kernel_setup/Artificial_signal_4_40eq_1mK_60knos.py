...
measured_temps=np.load('/albedo/work/projects/p_inverT/Ice_BT/data/Gaussian_pulse_signals/Artificial_measurements/Artificial_measurements_4_2_temps_40eq_signal_4.npy')
...
mu_T=0
sigma_pT=0.49 # prior on 60 kernel weights
...
Nwalker=122
Ndim=61
t_init = np.linspace(0, 499, 60)  
    
alpha_init = np.random.normal(loc=0, scale=sigma_pT, size=60)
POM_init = -44.0
...
#with open('/albedo/work/projects/p_inverT/Ice_BT/output/sampler_output/KS_final_runs/Artificial_signal_4_40eq_1mK_60knos.pkl', 'rb') as f:
...
with open('/albedo/work/projects/p_inverT/Ice_BT/output/sampler_output/KS_final_runs/Artificial_signal_4_40eq_1mK_60knos.pkl', 'wb') as f:
    dill.dump(sampler,f)
